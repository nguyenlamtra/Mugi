 ...
 *
 */
(function(n,t,i,r){"use strict";t=typeof t!="undefined"&&t.Math==Math?t:typeof self!="undefined"&&self.Math==Math?self:Function("return this")();n.fn.modal=function(u){var c=n(this),l=n(t),s=n(i),o=n("body"),a=c.selector||"",h=(new Date).getTime(),e=[],v=arguments[0],y=typeof v=="string",p=[].slice.call(arguments,1),w=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(n){setTimeout(n,0)},f;return c.each(function(){var b=n.isPlainObject(u)?n.extend(!0,{},n.fn.modal.settings,u):n.extend({},n.fn.modal.settings),it=b.selector,d=b.className,yt=b.namespace,ot=b.error,nt="."+yt,ct="module-"+yt,k=n(this),lt=n(b.context),wt=k.find(it.close),pt,rt,st,g,ht,tt=this,ut=k.data(ct),ft=!1,et,at,vt,c;c={initialize:function(){c.verbose("Initializing dimmer",lt);c.create.id();c.create.dimmer();c.refreshModals();c.bind.events();b.observeChanges&&c.observeChanges();c.instantiate()},instantiate:function(){c.verbose("Storing instance of modal");ut=c;k.data(ct,ut)},create:{dimmer:function(){var i={debug:b.debug,dimmerName:"modals",duration:{show:b.duration,hide:b.duration}},t=n.extend(!0,i,b.dimmerSettings);if(b.inverted&&(t.variation=t.variation!==r?t.variation+" inverted":"inverted"),n.fn.dimmer===r){c.error(ot.dimmer);return}c.debug("Creating dimmer with settings",t);g=lt.dimmer(t);b.detachable?(c.verbose("Modal is detachable, moving content into dimmer"),g.dimmer("add content",k)):c.set.undetached();b.blurring&&g.addClass(d.blurring);ht=g.dimmer("get dimmer")},id:function(){at=(Math.random().toString(16)+"000000000").substr(2,8);et="."+at;c.verbose("Creating unique id for element",at)}},destroy:function(){c.verbose("Destroying previous modal");k.removeData(ct).off(nt);l.off(et);ht.off(et);wt.off(nt);lt.dimmer("destroy")},observeChanges:function(){"MutationObserver"in t&&(vt=new MutationObserver(function(){c.debug("DOM tree modified, refreshing");c.refresh()}),vt.observe(tt,{childList:!0,subtree:!0}),c.debug("Setting up mutation observer",vt))},refresh:function(){c.remove.scrolling();c.cacheSizes();c.set.screenHeight();c.set.type();c.set.position()},refreshModals:function(){rt=k.siblings(it.modal);pt=rt.add(k)},attachEvents:function(t,i){var r=n(t);if(i=n.isFunction(c[i])?c[i]:c.toggle,r.length>0){c.debug("Attaching modal events to element",t,i);r.off(nt).on("click"+nt,i)}else c.error(ot.notFound,t)},bind:{events:function(){c.verbose("Attaching events");k.on("click"+nt,it.close,c.event.close).on("click"+nt,it.approve,c.event.approve).on("click"+nt,it.deny,c.event.deny);l.on("resize"+et,c.event.resize)}},get:{id:function(){return(Math.random().toString(16)+"000000000").substr(2,8)}},event:{approve:function(){if(ft||b.onApprove.call(tt,n(this))===!1){c.verbose("Approve callback returned false cancelling hide");return}ft=!0;c.hide(function(){ft=!1})},deny:function(){if(ft||b.onDeny.call(tt,n(this))===!1){c.verbose("Deny callback returned false cancelling hide");return}ft=!0;c.hide(function(){ft=!1})},close:function(){c.hide()},click:function(t){var r=n(t.target),u=r.closest(it.modal).length>0,f=n.contains(i.documentElement,t.target);!u&&f&&(c.debug("Dimmer clicked, hiding all modals"),c.is.active()&&(c.remove.clickaway(),b.allowMultiple?c.hide():c.hideAll()))},debounce:function(n,t){clearTimeout(c.timer);c.timer=setTimeout(n,t)},keyboard:function(n){var t=n.which;t==27&&(b.closable?(c.debug("Escape key pressed hiding modal"),c.hide()):c.debug("Escape key pressed, but closable is set to false"),n.preventDefault())},resize:function(){g.dimmer("is active")&&w(c.refresh)}},toggle:function(){c.is.active()||c.is.animating()?c.hide():c.show()},show:function(t){t=n.isFunction(t)?t:function(){};c.refreshModals();c.showModal(t)},hide:function(t){t=n.isFunction(t)?t:function(){};c.refreshModals();c.hideModal(t)},showModal:function(t){t=n.isFunction(t)?t:function(){};c.is.animating()||!c.is.active()?(c.showDimmer(),c.cacheSizes(),c.set.position(),c.set.screenHeight(),c.set.type(),c.set.clickaway(),!b.allowMultiple&&c.others.active()?c.hideOthers(c.showModal):(b.onShow.call(tt),b.transition&&n.fn.transition!==r&&k.transition("is supported")?(c.debug("Showing modal with css animations"),k.transition({debug:b.debug,animation:b.transition+" in",queue:b.queue,duration:b.duration,useFailSafe:!0,onComplete:function(){b.onVisible.apply(tt);b.keyboardShortcuts&&c.add.keyboardShortcuts();c.save.focus();c.set.active();b.autofocus&&c.set.autofocus();t()}})):c.error(ot.noTransition))):c.debug("Modal is already visible")},hideModal:function(t,i){if(t=n.isFunction(t)?t:function(){},c.debug("Hiding modal"),b.onHide.call(tt,n(this))===!1){c.verbose("Hide callback returned false cancelling hide");return}(c.is.animating()||c.is.active())&&(b.transition&&n.fn.transition!==r&&k.transition("is supported")?(c.remove.active(),k.transition({debug:b.debug,animation:b.transition+" out",queue:b.queue,duration:b.duration,useFailSafe:!0,onStart:function(){c.others.active()||i||c.hideDimmer();b.keyboardShortcuts&&c.remove.keyboardShortcuts()},onComplete:function(){b.onHidden.call(tt);c.restore.focus();t()}})):c.error(ot.noTransition))},showDimmer:function(){g.dimmer("is animating")||!g.dimmer("is active")?(c.debug("Showing dimmer"),g.dimmer("show")):c.debug("Dimmer already visible")},hideDimmer:function(){if(g.dimmer("is animating")||g.dimmer("is active"))g.dimmer("hide",function(){c.remove.clickaway();c.remove.screenHeight()});else{c.debug("Dimmer is not visible cannot hide");return}},hideAll:function(t){var i=pt.filter("."+d.active+", ."+d.animating);t=n.isFunction(t)?t:function(){};i.length>0&&(c.debug("Hiding all visible modals"),c.hideDimmer(),i.modal("hide modal",t))},hideOthers:function(t){var i=rt.filter("."+d.active+", ."+d.animating);t=n.isFunction(t)?t:function(){};i.length>0&&(c.debug("Hiding other modals",rt),i.modal("hide modal",t,!0))},others:{active:function(){return rt.filter("."+d.active).length>0},animating:function(){return rt.filter("."+d.animating).length>0}},add:{keyboardShortcuts:function(){c.verbose("Adding keyboard shortcuts");s.on("keyup"+nt,c.event.keyboard)}},save:{focus:function(){st=n(i.activeElement).blur()}},restore:{focus:function(){st&&st.length>0&&st.focus()}},remove:{active:function(){k.removeClass(d.active)},clickaway:function(){b.closable&&ht.off("click"+et)},bodyStyle:function(){o.attr("style")===""&&(c.verbose("Removing style attribute"),o.removeAttr("style"))},screenHeight:function(){c.debug("Removing page height");o.css("height","")},keyboardShortcuts:function(){c.verbose("Removing keyboard shortcuts");s.off("keyup"+nt)},scrolling:function(){g.removeClass(d.scrolling);k.removeClass(d.scrolling)}},cacheSizes:function(){var u=k.outerHeight();(c.cache===r||u!==0)&&(c.cache={pageHeight:n(i).outerHeight(),height:u+b.offset,contextHeight:b.context=="body"?n(t).height():g.height()});c.debug("Caching modal and container sizes",c.cache)},can:{fit:function(){return c.cache.height+b.padding*2<c.cache.contextHeight}},is:{active:function(){return k.hasClass(d.active)},animating:function(){return k.transition("is supported")?k.transition("is animating"):k.is(":visible")},scrolling:function(){return g.hasClass(d.scrolling)},modernBrowser:function(){return!(t.ActiveXObject||"ActiveXObject"in t)}},set:{autofocus:function(){var n=k.find("[tabindex], :input").filter(":visible"),t=n.filter("[autofocus]"),i=t.length>0?t.first():n.first();i.length>0&&i.focus()},clickaway:function(){if(b.closable)ht.on("click"+et,c.event.click)},screenHeight:function(){c.can.fit()?o.css("height",""):(c.debug("Modal is taller than page content, resizing page height"),o.css("height",c.cache.height+b.padding*2))},active:function(){k.addClass(d.active)},scrolling:function(){g.addClass(d.scrolling);k.addClass(d.scrolling)},type:function(){c.can.fit()?(c.verbose("Modal fits on screen"),c.others.active()||c.others.animating()||c.remove.scrolling()):(c.verbose("Modal cannot fit on screen setting to scrolling"),c.set.scrolling())},position:function(){c.verbose("Centering modal on page",c.cache);c.can.fit()?k.css({top:"",marginTop:-(c.cache.height/2)}):k.css({marginTop:"",top:s.scrollTop()})},undetached:function(){g.addClass(d.undetached)}},setting:function(t,i){if(c.debug("Changing setting",t,i),n.isPlainObject(t))n.extend(!0,b,t);else if(i!==r)n.isPlainObject(b[t])?n.extend(!0,b[t],i):b[t]=i;else return b[t]},internal:function(t,i){if(n.isPlainObject(t))n.extend(!0,c,t);else if(i!==r)c[t]=i;else return c[t]},debug:function(){!b.silent&&b.debug&&(b.performance?c.performance.log(arguments):(c.debug=Function.prototype.bind.call(console.info,console,b.name+":"),c.debug.apply(console,arguments)))},verbose:function(){!b.silent&&b.verbose&&b.debug&&(b.performance?c.performance.log(arguments):(c.verbose=Function.prototype.bind.call(console.info,console,b.name+":"),c.verbose.apply(console,arguments)))},error:function(){b.silent||(c.error=Function.prototype.bind.call(console.error,console,b.name+":"),c.error.apply(console,arguments))},performance:{log:function(n){var t,i,r;b.performance&&(t=(new Date).getTime(),r=h||t,i=t-r,h=t,e.push({Name:n[0],Arguments:[].slice.call(n,1)||"",Element:tt,"Execution Time":i}));clearTimeout(c.performance.timer);c.performance.timer=setTimeout(c.performance.display,500)},display:function(){var t=b.name+":",i=0;h=!1;clearTimeout(c.performance.timer);n.each(e,function(n,t){i+=t["Execution Time"]});t+=" "+i+"ms";a&&(t+=" '"+a+"'");(console.group!==r||console.table!==r)&&e.length>0&&(console.groupCollapsed(t),console.table?console.table(e):n.each(e,function(n,t){console.log(t.Name+": "+t["Execution Time"]+"ms")}),console.groupEnd());e=[]}},invoke:function(t,i,u){var e=ut,h,o,s;return i=i||p,u=tt||u,typeof t=="string"&&e!==r&&(t=t.split(/[\. ]/),h=t.length-1,n.each(t,function(i,u){var f=i!=h?u+t[i+1].charAt(0).toUpperCase()+t[i+1].slice(1):t;if(n.isPlainObject(e[f])&&i!=h)e=e[f];else{if(e[f]!==r)return o=e[f],!1;if(n.isPlainObject(e[u])&&i!=h)e=e[u];else return e[u]!==r?(o=e[u],!1):!1}})),n.isFunction(o)?s=o.apply(u,i):o!==r&&(s=o),n.isArray(f)?f.push(s):f!==r?f=[f,s]:s!==r&&(f=s),o}};y?(ut===r&&c.initialize(),c.invoke(v)):(ut!==r&&ut.invoke("destroy"),c.initialize())}),f!==r?f:this};n.fn.modal.settings={name:"Modal",namespace:"modal",silent:!1,debug:!1,verbose:!1,performance:!0,observeChanges:!1,allowMultiple:!1,detachable:!0,closable:!0,autofocus:!0,inverted:!1,blurring:!1,dimmerSettings:{closable:!1,useCSS:!0},keyboardShortcuts:!0,context:"body",queue:!1,duration:500,offset:0,transition:"scale",padding:50,onShow:function(){},onVisible:function(){},onHide:function(){return!0},onHidden:function(){},onApprove:function(){return!0},onDeny:function(){return!0},selector:{close:"> .close",approve:".actions .positive, .actions .approve, .actions .ok",deny:".actions .negative, .actions .deny, .actions .cancel",modal:".ui.modal"},error:{dimmer:"UI Dimmer, a required component is not included in this page",method:"The method you called is not defined.",notFound:"The element you specified could not be found"},className:{active:"active",animating:"animating",blurring:"blurring",scrolling:"scrolling",undetached:"undetached"}}})(jQuery,window,document);
/*!
